...
function ColonoscopyCancerScreening() {
    return (
        ...
        <h2> Colonoscopy and Cancer Screening </h2>
        <p className="sectionText"> 
            ...
            or narrowing, polyps and neoplasm or cancer.
            ...
            The colonoscopy is considered the gold standard of colorectal cancer screening.
